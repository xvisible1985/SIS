      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        <div className="flex-1 flex flex-col overflow-hidden border-r border-gray-200 dark:border-gray-700/30">
          <div className="flex justify-between px-2 py-0.5 border-b border-gray-200 dark:border-gray-700/20 flex-shrink-0">
            ...
            <span className="text-[9px] text-gray-500 dark:text-gray-400">Объём</span>
          </div>
          <div className="flex-1 overflow-auto">
            {bids.map(([price, size]) => (
              <div key={price} className="relative flex justify-between px-2 py-[2px] hover:bg-green-500/5">
                ...
                <span className="relative text-[10px] font-mono text-gray-500 dark:text-gray-400 z-10">{parseFloat(size).toFixed(3)}</span>
              </div>
            ))}
